...
export default function AuthScreen() {
    ...
    useEffect(() => {
        const clearStorage = async () => {
            await AsyncStorage.removeItem('device_id'); // Clear AsyncStorage for testing purposes
        }
        clearStorage();
    }, [])
    ...
    const checkFirstTimeUser = async () => {
        const userFlag = await AsyncStorage.getItem('userRegistered');
        setIsFirstTime(userFlag !== 'true');
    }
    ...
    const authenticate = async () => {
        try {
            ...
            if (isFirstTime) {
                ...
                router.push('/'); // Navigate to registration screen
                return;
            }
            ...
            if (!hasHardware || !isEnrolled) {
                router.push('/'); // Navigate to PIN screen
                return;
            }
            ...
            <View style={styles.content}>
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.instructionText}>
                        {isFirstTime 
                            ? 'Let’s get you set up. Tap below to begin registration.' 
                            : (hasBiometrics 
